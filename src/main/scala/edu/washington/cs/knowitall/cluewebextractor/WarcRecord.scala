 ...
 *   WARC-Record-ID    : A legal URI that is "globally unique for its
 *                       period of intended use"
 *   Content-Length    : The number of octets in the block.
 *   WARC-Date         : A 14-digit UTC timestamp formatted according to
 *                       YYYY-MM-DDThh:mm:ssZ.
 *   WARC-Type         : The type of record: one of "warcinfo", "response",
 ...
 *   Content-Type      : The MIME type of the information in the record's block.
 *   WARC-Concurrent-To: The WARC-Record-IDs of any records create as part of
 ...
 *   WARC-Block-Digest : An optional parameter indicating the algorithm name
 ...
 *   WARC-IP-Address   : The numeric Internet address contacted to retrieve
 *                       any included content. May be either IPv4/6.
 *   WARC-Refers-To    : The WARC-Record-ID of a single record for which
 ...
 *   WARC-Target-URI   : The original URI whose capture gave rise to the
 *                       information content in this record.
 *   WARC-Truncated    : If this field is present, the current record was
 ...
 *                       Length field.
 *   WARC-Warcinfo-ID  : Indicates the Warc-Record-ID of the associated
 ...
 *   WARC-Filename     : The filename containing the current 'warcinfo' record.
 *                       Only used for 'warcinfo'-type records.
 *   WARC-Profile      : URI signifying the kind of analysis and handling
 ...
 *                     : The number of ClueWeb12 documents contained in the
 *                       file.
 *   WARC-File-Length  : The length, in bytes, of the uncompressed file
 *   WARC-Data-Type    : A short description of the type of documents contained
 *                       in the file, i.e. web crawl.
 * For warc records:
 *   WARC-TREC-ID      : A globally unique identifier for the dataset that
